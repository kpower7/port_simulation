...
for container in range(page_number):
    ...
    #changed date range, UNIX date format, latest date goes first
    data = {"searchId":23423942,"pagination":{"page":k,"pageSize":100},"sortBy":{"field":"arrivalDate","direction":"DESC"},"contextId":"ccd80d62f75941d701f73707c0107b84","params":{"filter":[{"operator":"and","type":"text","input":{"keyword":"New York","modifier":"contains","field":"usPort"}}],"searchDates":[1733011200, 1733193599],"searchOptions":{}},"showGlobalData":[]}
...
df.to_csv(f"{PATH}/Results_dec1-3.csv")
