...
for category in categories:
    ...
    # Analyze common discharge-to-gateout patterns
    discharge_hours = subset['discharge_hour'].value_counts().sort_index()
    gateout_hours = subset['gateout_hour'].value_counts().sort_index()
