...
def add_tracks():
    ...
    center_y = 20             # Center of the tracks
...
class TrainRTG(sim.Component):
    def setup(self, x_position, y_position, trolley_speed=0.5, spreader_speed=0.2):
    ...
    def process(self):
        while True:
            ...
            self.hold(0.1)  # Short time step for smooth animation
...
# Add train
Train(num_trolleys=20, start_x=100, start_y=21, speed=0.1)
# Add RTGs at both ends of the tracks
# Add Train RTGs
TrainRTG(x_position=100, y_position=21)  # RTG near the start of the tracks
TrainRTG(x_position=700, y_position=21)  # RTG near the end of the tracks
